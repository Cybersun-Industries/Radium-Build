...
#pragma warning restore NUnit2045
                ...
                await server.WaitAssertion(() =>
                {
                    ...
                    {
                        Assert.That(foundProductsMap.TryFirstOrNull(x => x.Key.Key == reagent.Prototype && x.Key.Value == quantity, out var foundProduct), message:$"Failed at reaction prototype: {reactionPrototype.ID}");
