...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        public AudioTab()
        {
            ...
            TtsAnnounceVolumeSlider.OnValueChanged += OnTtsAnnounceVolumeSliderChanged; // Corvax-TTS
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCCVars.TTSAnnounceVolume, LV100ToDB(TtsAnnounceVolumeSlider.Value)); // Corvax-TTS
        ...
        private void Reset()
        {
            ...
            TtsAnnounceVolumeSlider.Value = DBToLV100(_cfg.GetCVar(CCCVars.TTSAnnounceVolume)); // Corvax-TTS
        ...
        private void UpdateChanges()
        {
            ...
            var isTtsAnnounceVolumeSame = Math.Abs(TtsAnnounceVolumeSlider.Value - DBToLV100(_cfg.GetCVar(CCCVars.TTSAnnounceVolume))) < 0.01f; // Corvax-TTS
